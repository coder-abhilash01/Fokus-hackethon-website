    ...
    >
      <div className="bg-black/40 backdrop-blur-xl border border-white/20 shadow-2xl rounded-2xl p-8 md:p-12 w-full max-w-md animate-fade-in">
        ...
        <form className="space-y-5">
          ...
          <button
            type="submit"
            className="w-full py-2 rounded-lg bg-gradient-to-r from-yellow-400 to-pink-500 text-black font-semibold shadow-lg hover:shadow-yellow-300/40 transition-all duration-300 hover:-translate-y-[2px] pointer"
          >
            Register
          </button>
        </form>
